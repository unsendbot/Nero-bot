...
module.exports = {
	config: {
		...
		guide: {
			...
			ar: "   {pn}: يرسل ايديك"
				+ "\n   {pn} @tag: يرسل ايدي اللي سويت له تاغ "
				+ "\n   {pn} <profile link>: يرسل ايدي الشخص اللي حطيت رابطه"
				+ "\n   اذا رديت على شخص يجيب لك ايديه ايضا"
		}
	},
	...
	langs: {
		...
		ar: {
		    syntaxError: "من فضلك حط تاغ للشخص الذي تريد رؤية معرفه او خليه فارغ لرؤية ايديك الخاص"
		}
	},
