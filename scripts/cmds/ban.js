...
module.exports = {
	config: {
		...
		guide: {
            vi: "   {pn} [@tag|uid|link fb|reply] [<lý do cấm>|để trống nếu không có lý do]: Cấm thành viên khỏi box chat"
             ...
             ar: "   {pn} [@tag|uid|رابط الفيسبوك|الرد] [<السبب>|اتركه فارغا إذا لم يكن هناك سبب]: حظر المستخدم من المجموعة"
             + "\n   {pn} تفقد: التحقق من الأعضاء المحظورين وطردهم من المجموعة"
             + "\n   {pn} فك [@tag|uid|رابط الفيسبوك|الرد]: إلغاء حظر المستخدم من المجموعة"
	...
	langs: {
		...
		ar: {
           notFoundTarget: "⚠️ | يرجى وضع علامة على الشخص المراد حظره أو إدخال رقم معرف أو رابط Facebook أو الرد على رسالة الشخص المراد حظره",
           notFoundTargetUnban: "⚠️ | يرجى وضع علامة على الشخص المراد إلغاء حظره أو إدخال رقم معرف أو رابط Facebook أو الرد على رسالة الشخص المراد إلغاء حظره",
           userNotBanned: "⚠️ | الشخص برقم معرف %1 ليس محظورًا من هذه المجموعة",
           ...
           needAdmin: "⚠️ | يحتاج البوت إلى صلاحيات المسؤول لطرد الأعضاء المحظورين",
           noName: "مستخدم Facebook",
           noData: "📑 | لا توجد أعضاء محظورين في هذه المجموعة",
           listBanned: "📑 | قائمة الأعضاء المحظورين في هذه المجموعة (الصفحة %1/%2)",
           content: "%1/ %2 (%3)\nالسبب: %4\nوقت الحظر: %5\n\n",
           needAdminToKick: "⚠️ | العضو %1 (%2) تم حظره من المجموعة، ولكن البوت ليس لديه صلاحيات المسؤول لطرد هذا العضو، يرجى منح البوت صلاحيات المسؤول لطرد هذا العضو",
           bannedKick: "⚠️ | تم حظر %1 من المجموعة من قبل!\nالمعرف: %2\nالسبب: %3\nوقت الحظر: %4\n\nتم طرد هذا العضو تلقائيًا من قبل البوت"
       }
	},
	...
	onStart: async function ({ message, event, args, threadsData, getLang, usersData, api }) {
		...
		else if (args[0] == "check" || args[0] == "تفقد") {
