module.exports = {
	config: {
		...
		guide: {
			...
			ar: "   {pn}:يريك كم ترتيبك و عدد رسائلك"
			  + "\n   {pn} الكل: يحسب رسائل الكل"
		}
	},
	...
	langs: {
		...
		ar: {
			...
			page: "الصفحة %1/%2",
			endMessage: "مفش اسم حد يعني هو صنم",
			reply: "رد على هذه الرسالة لرؤية المزيد",
			result: "%1 ترتيبه %2 ب %3 رسالة.",
			yourResult: "ترتيبك %1 وعدد رسائلك %2 رسالة",
			invalidPage: "مش رقم جيد 😕"
		}
	},
